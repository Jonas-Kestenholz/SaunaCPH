...
## Alternativer og fravalg

Alternativer:
- Custom backend (Node.js + database)
- Firebase (Firestore + auth)
- Headless CMS + egen checkout

Fravalg begrundet i:
- Øget kompleksitet
- Længere udviklingstid
- Større vedligeholdelsesansvar

Valg af Shopify:
- Samler produkt, checkout og kunder ét sted
- Reducerer behov for backend
- Understøtter hurtig udvikling

## Trade-offs

Valg af Shopify reducerer kompleksitet,
men medfører:

- Afhængighed af platform
- Begrænset fleksibilitet

Dette er accepteret i version 1,
da fokus er hurtig levering og stabil drift.