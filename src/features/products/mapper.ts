...
export function mapProduct(response: GetProductQueryResponse): ProductDetail {
  ...
  return {
    ...
    sizeChart: response.product.sizeChart?.reference
      ? {
          title: response.product.sizeChart.reference.title ?? undefined,
          handle: response.product.sizeChart.reference.handle ?? undefined,
          body: response.product.sizeChart.reference.body ?? undefined,
          bodySummary:
            response.product.sizeChart.reference.bodySummary ?? undefined,
        }
      : undefined,
